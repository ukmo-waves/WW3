...
!  1. Purpose :
!
!     Manages namelists from configuration file ww3_mopp.nml for ww3_mopp program
!
!/ ------------------------------------------------------------------- /
  ...
  CONTAINS
!/ ------------------------------------------------------------------- /
  SUBROUTINE W3NMLMOPP (NDSI, INFILE, NML_FIELD, NML_FILE, NML_SMC, IERR)
!/
!/                  +-----------------------------------+
!/                  | WAVEWATCH III           NOAA/NCEP |
!/                  |           M. Accensi              |
...
!      Name      TYPE  Module   Description
!     ----------------------------------------------------------------
!      WW3_MOPP  Prog.   N/A    Postprocess output fields.
!     ----------------------------------------------------------------
!
!  6. Error messages :
!
...
!      Name      TYPE  Module   Description
!     ----------------------------------------------------------------
!      W3NMLMOPP Subr.   N/A    Namelist configuration routine.
!     ----------------------------------------------------------------
!
!  6. Error messages :
!
...
!/ ------------------------------------------------------------------- /
    ...
    CALL STRACE (IENT, 'REPORT_FIELD_NML')
      ...
      WRITE (NDSN,10) TRIM(MSG),'TIMEREF    = ', TRIM(NML_FIELD%TIMEREF)
